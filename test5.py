...
gr.Interface(
    ...
    description="Expands abbreviations using both a global base list and a category-specific list (auto-detected using Claude). Replaces repeated full names with the last name."
).launch()
